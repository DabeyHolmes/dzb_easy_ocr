...
data_dir = ''
train_data_dir = os.path.join(data_dir, 'C:/Users/dzb/PycharmProjects/easy_ocr/HWDB1.1trn_gnt')
test_data_dir = os.path.join(data_dir, 'C:/Users/dzb/PycharmProjects/easy_ocr/HWDB1.1tst_gnt')
